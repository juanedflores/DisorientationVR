...
AFRAME.registerComponent('audioanalyser', {
  ...
  tick: function () {
    ...
    if (t.enabled) {
      if (
        ...
        t.enableWaveform && this.analyser.getByteTimeDomainData(this.waveform),
        t.enableVolume || t.enableBeatDetection)
      ) {
        for (var e = 0, i = 0; i < this.levels.length; i++) e += this.levels[i];
        this.volume = e / this.levels.length;
      }
      if (t.enableBeatDetection) {
        var a = this.beatInRange(
          1,
          350,
          this.beat_low,
          this.beat_low_max,
  ...
  beatInRange: function (t, e, i, a, n) {
    ...
    return u >= (a = Math.max(u, a)) * this.data.beatStartCutoff && 0 == i
      ? (this.el.emit(n, null, !1), [!0, a])
      : u < a * this.data.beatEndCutoff && 1 == i
      ? [!1, a]
      : [i, a];
  },
  ...
  fetchAudioBuffer: function (t) {
    ...
    return e[t]
      ...
      : (this.data.cache ||
        ...
        (e[t] = new Promise(function (a) {
          var n = (i.xhr = new XMLHttpRequest());
          n.open('GET', t),
            ...
            n.addEventListener('load', function () {
              ...
              var o = i.context.decodeAudioData(n.response, s);
              o && o.constructor === Promise && o.then(s).catch(console.error);
            }),
            n.send();
        })),
        e[t]);
  ...
  getBufferSource: function () {
    ...
    return this.fetchAudioBuffer(i.src)
      .then(function () {
        var a = t.context.createBufferSource();
        return (
          (a.buffer = e[i.src]),
          t.el.emit('audioanalyserbuffersource', a, !1),
          a
        );
      })
      .catch(console.error);
